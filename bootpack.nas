...
_console_task:
	...
	MOV	EBX,DWORD [-600+EBP]
	PUSH	EAX
	ADD	EBX,16
	PUSH	128
	PUSH	EBX
	MOV	DWORD [-608+EBP],28
	CALL	_fifo32_init
	CALL	_timer_alloc
	PUSH	1
	PUSH	EBX
...
L132:
	...
	ADD	EAX,DWORD [-592+EBP]
	MOV	EDX,DWORD [ESI]
	MOV	BYTE [EAX+EDX*1],0
	INC	DWORD [-592+EBP]
	CMP	DWORD [-592+EBP],247
	JLE	L132
	INC	EBX
	CMP	EBX,155
	JLE	L133
...
L166:
	...
	CMP	DWORD [-592+EBP],EBX
	JGE	L197
L196:
	MOV	ECX,DWORD [-592+EBP]
